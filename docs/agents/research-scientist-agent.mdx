...
<Info>
  ...
  **Best For:** Research papers, novel algorithms, academic methodology, citations
</Info>
...
- **[experiment-analyst-agent](/agents/experiment-analyst-agent)** - A/B testing, experiment design, statistical significance, analysis
...
<CardGroup cols={2}>
  ...
  <Card title="AI/ML" icon="microscope" href="/agents/overview#ai/ml">
    More AI/ML agents
  </Card>
