...
- [`/quality:api-gen`](/commands/quality-api-gen) - Activates this agent
...
| Command | Description |
|---------|-------------|
| [`/quality:api-gen`](/commands/quality-api-gen) | Generate API code from spec |
| [`/workflow:api-design`](/commands/workflow-api-design) | Design RESTful or GraphQL APIs |
