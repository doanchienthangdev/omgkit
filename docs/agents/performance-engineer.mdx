...
| Command | Description |
|---------|-------------|
| [`/perf:benchmark`](/commands/perf-benchmark) | Run performance benchmarks and generate reports |
| [`/perf:profile`](/commands/perf-profile) | Profile application performance and identify bottlenecks |
