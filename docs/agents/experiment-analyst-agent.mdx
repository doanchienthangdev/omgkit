...
<Info>
  ...
  **Best For:** A/B testing, experiment design, statistical significance, analysis
</Info>
...
- **Edge cases**: Errors concentrated in samples with fewer than 10 tokens (data sparsity)
...
- **[data-scientist-agent](/agents/data-scientist-agent)** - Data analysis, statistical modeling, hypothesis testing, insights
- **[ml-engineer-agent](/agents/ml-engineer-agent)** - ML model development, training pipelines, feature engineering
- **[research-scientist-agent](/agents/research-scientist-agent)** - Research papers, novel algorithms, academic methodology, citations
...
<CardGroup cols={2}>
  ...
  <Card title="AI/ML" icon="flask" href="/agents/overview#ai/ml">
    More AI/ML agents
  </Card>
