...
| [`/sprint:sprint-new`](/commands/sprint-sprint-new) | Create new sprint with optional reference sources |
...
| [`/sprint:ship`](/commands/sprint-ship) | Complete sprint and ship to production |
| [`/sprint:backlog-add`](/commands/sprint-backlog-add) | Add task to backlog with optional reference context |
...
| [`/sprint:team-run`](/commands/sprint-team-run) | Run AI team on sprint tasks with configurable test enforceme... |
