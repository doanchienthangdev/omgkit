...
| [devops/aws](/skills/aws) | The agent implements AWS cloud solutions with Lambda, S3, Dy... |
...
| Command | Description |
|---------|-------------|
| [`/platform:blueprint`](/commands/platform-blueprint) | Create internal developer platform blueprint with golden pat... |

### Used By Workflows

| Workflow | Description |
|----------|-------------|
| [microservices/service-mesh-setup](/workflows/service-mesh-setup) | Configure service mesh for traffic management and security |
