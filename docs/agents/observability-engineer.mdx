...
<Info>
  ...
  **Best For:** Monitoring, logging, tracing, alerting, SLO management
</Info>
...
```bash
# Invoke directly
@observability-engineer "your task description here"
```
...
| Skill | Description |
|-------|-------------|
| [devops/observability](/skills/observability) | Production observability with structured logging, metrics co... |
| [devops/performance-profiling](/skills/performance-profiling) | Performs browser performance profiling with Lighthouse, Core... |

### Commands Triggered

| Command | Description |
|---------|-------------|
| [`/sre:dashboard`](/commands/sre-dashboard) | Design and configure SRE observability dashboards with SLI/S... |
...
```bash
@observability-engineer "describe what you need done"
```
...
@observability-engineer "create implementation plan based on research"
```
...
```bash
/team:run
# Sprint Master will automatically assign observability-engineer to appropriate tasks
```
...
<CardGroup cols={2}>
  ...
  <Card title="Operations" icon="chart-line" href="/agents/overview#operations">
