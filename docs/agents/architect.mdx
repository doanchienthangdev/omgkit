...
<Info>
  ...
  **Best For:** System architecture, design patterns, scalability
</Info>
...
```bash
@architect "describe what you need done"
```
...
@architect "create implementation plan based on research"
```
...
```bash
/team:run
# Sprint Master will automatically assign architect to appropriate tasks
```
...
<CardGroup cols={2}>
  ...
  <Card title="Omega Exclusive" icon="building" href="/agents/overview#omega-exclusive">
