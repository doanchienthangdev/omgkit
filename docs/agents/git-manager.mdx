...
- [`/commit`](/commands/commit) - Activates this agent
- [`/pr`](/commands/pr) - Activates this agent
- [`/ship`](/commands/ship) - Activates this agent
- [`/cm`](/commands/cm) - Activates this agent
- [`/cp`](/commands/cp) - Activates this agent
