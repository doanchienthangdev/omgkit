...
| Skill | Description |
|-------|-------------|
| [iot/edge-computing](/skills/edge-computing) |  |
| [iot/device-provisioning](/skills/device-provisioning) |  |
| [iot/mqtt-deep](/skills/mqtt-deep) |  |
| [iot/ota-updates](/skills/ota-updates) |  |

### Commands Triggered

| Command | Description |
|---------|-------------|
| [`/iot:provision`](/commands/iot-provision) | Provision and configure IoT devices with secure fleet manage... |
