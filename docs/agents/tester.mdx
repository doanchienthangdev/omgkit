...
<Info>
  ...
  **Best For:** Test creation, coverage improvement, quality assurance
</Info>
...
```bash
# Invoke directly
@tester "your task description here"
```
...
- [`/dev:test`](/commands/dev-test) - Activates this agent
- [`/dev:tdd`](/commands/dev-tdd) - Activates this agent
- [`/dev:fix-test`](/commands/dev-fix-test) - Activates this agent
...
| [methodology/testing-anti-patterns](/skills/testing-anti-patterns) | AI agent identifies and fixes common testing anti-patterns t... |
...
| [testing/pytest](/skills/pytest) | Claude writes comprehensive Python tests using pytest. Use w... |
...
| [`/dev:test-write`](/commands/dev-test-write) | Write comprehensive tests following OMGKIT Omega Testing met... |
...
| [game-dev/playtesting](/workflows/playtesting) | Systematic playtesting workflow for game quality |
...
```bash
@tester "describe what you need done"
```
...
@tester "create implementation plan based on research"
```
...
```bash
/team:run
# Sprint Master will automatically assign tester to appropriate tasks
```
...
<CardGroup cols={2}>
  ...
  <Card title="Core Development" icon="flask-vial" href="/agents/overview#core-development">
