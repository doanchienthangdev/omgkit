...
- [`/plan`](/commands/plan) - Activates this agent
- [`/plan:detailed`](/commands/plan-detailed) - Activates this agent
- [`/plan:parallel`](/commands/plan-parallel) - Activates this agent
