...
<CardGroup cols={3}>
  ...
  <Card title="Microservices" icon="cubes" href="/autonomous/archetypes#microservices">
    Distributed services with API gateway and K8s
  </Card>
  <Card title="Event-Driven" icon="bolt" href="/autonomous/archetypes#event-driven">
    Async systems with message brokers and CQRS
  </Card>
</CardGroup>
