...
These commands control the autonomous development system, from project initialization through deployment. The system supports [14 project archetypes](/autonomous/archetypes) and leverages the [artifacts system](/autonomous/overview#artifacts-system) for enhanced context.
...
Based on your answers, the system recommends one of 14 archetypes:
...
| Distributed microservices | [Microservices](/autonomous/archetypes#microservices) |
| Async event system | [Event-Driven](/autonomous/archetypes#event-driven) |
...
- [Project Archetypes](/autonomous/archetypes) - All 14 project templates
