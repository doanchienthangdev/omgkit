...
Cross-platform mobile development with React Native and Expo including navigation, state management, and native features
...
<CardGroup cols={2}>
  ...
  <Card title="Mobile" icon="mobile" href="/skills/overview#mobile">
    More mobile skills
  </Card>
</CardGroup>
