...
<Info>
  ...
  **Triggers:** image processing, sharp, image optimization, resize images, image conversion, thumbnail generation, webp avif
</Info>

## Overview

Enterprise image manipulation with Sharp including optimization, resizing, format conversion, and batch operations
