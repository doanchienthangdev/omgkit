...
- **[ai-engineering/prompt-engineering](/skills/ai-engineering/prompt-engineering)** - Domain expertise
...
| Skill | Description |
|-------|-------------|
| [ai-engineering/prompt-engineering](/skills/prompt-engineering) | Designing effective prompts - system/user prompts, few-shot ... |
